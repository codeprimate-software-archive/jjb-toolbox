...
public interface FormatSchema {
   ...
   * text.
   *
   * @param doc javax.swing.text.Document object model of the JTextField
   * using this schema, containing the content of the field.
   * @param offset is an integer value specifying the offset into the 
   * document.
   * @param text java.lang.String object containing the text to format and
   * valid before inserting into the JTextField component.
   * @throws jjb.toolbox.swing.text.IllegalTextFormatException if the text
