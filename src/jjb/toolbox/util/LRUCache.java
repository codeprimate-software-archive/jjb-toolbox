...
public class LRUCache extends AbstractCache {
  ...
  /**
   * Creates an instance of the LRUCache object to cache objects.  The cache
  ...
  /**
   * Creates an instance of the LRUCache object to cache object up to the 
  ...
  /**
   * Copy constructor.  Creates an instance of the LRUCache class from an
   ...
   */
  public LRUCache(Cache oldCache) {
  ...
  private final class LRUComparator implements Comparator {
  ...
  } // End of LRUComparator Class

  /**
   * purgeCache using Least Recently Used algorithm to remove Cacheable
   * objects based on their last hit time stamp.
   */
  protected void purgeCache() {
    ...
    if (cache.size() > maxSize) {
      ...
      // Least Recently Used Cacheable objects will be at the 
      // front of the List using the LRUComparator.
      Collections.sort(cacheList,new LRUComparator());
   ...
   * from the cache.
   *
   * @param key java.lang.String object referring to the Cacheable object of
   * interests in cache.
   ...
   *
   * @param cacheObject Cacheable object to store in this cache and to be
   * shared by other modules of the application.
   * @throws java.lang.NullPointerException if the key (unique identifier)
   * parameter is null.
   */
