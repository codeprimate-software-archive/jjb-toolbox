/**
 * DefaultFormatSchema.java (c) 2002.4.17
 *
 * The DefaultFormatSchema class is a place holder, do nothing schema.
 * This schema returns the inputed text to the JFormattedField exactly
 * as recieved.
 *
...
public class DefaultFormatSchema extends AbstractFormatSchema {
