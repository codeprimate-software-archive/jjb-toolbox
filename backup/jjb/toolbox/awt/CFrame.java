 ...
 * @since Java 1.0
 * @deprecated programmers should extend the java.awt.Frame class
 * instead and use the Utility classes to provide the functionality
 * for features such as getDialogLocation, etc.
 */
...
public abstract class CFrame extends Frame implements FormIF
{
   ...
   *
   * @param gc is a Ljava.awt.GraphicsConfiguration of the target screen device.
   ...
   * 
   * @param title is a Ljava.lang.String title to be displayed in the frame's
   * border. A null value is treated as an empty string, "".
   */
